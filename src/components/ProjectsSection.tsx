    ...
    const projects = [
        {
            ...
            description:
                "Built a software solution that helps in generating food item receipts of PICT College Cafeteria. The software helps the owner analyse the number of food items sold on a particular day along with their frequency.",
        ...
        },
        {
            ...
            description:
                "A full-stack e-commerce platform with advanced features including payment integration, order management, and admin dashboard. Built with modern technologies and deployed on AWS.",
            ...
            githubLink:
                "https://github.com/saurabhchidrewar/ecommerce-platform",
        ...
        },
        {
            ...
            description:
                "A collaborative task management application with real-time updates, team collaboration features, and project tracking capabilities. Built with modern web technologies.",
